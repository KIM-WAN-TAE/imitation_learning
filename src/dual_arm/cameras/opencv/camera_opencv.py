...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from dual_arm.cameras.opencv import OpenCVCamera
        from dual_arm.cameras.configuration_opencv import OpenCVCameraConfig
    ...
    def connect(self, warmup: bool = True) -> None:
        ...
        if not self.videocapture.isOpened():
            ...
            raise ConnectionError(
                f"Failed to open {self}.Run `dual_arm-find-cameras opencv` to find available cameras."
            )
