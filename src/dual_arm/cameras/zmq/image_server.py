...
Uses dual_arm's OpenCVCamera for capture, encodes images to base64 and sends them over ZMQ.
"""
...
from dual_arm.cameras.opencv import OpenCVCamera, OpenCVCameraConfig
