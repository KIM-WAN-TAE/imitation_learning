...
from dual_arm.utils.errors import DeviceNotConnectedError
...
class RealSenseCamera(Camera):
    ...
    ```bash
    dual_arm-find-cameras realsense
    ```
    ...
    Example:
        ```python
        from dual_arm.cameras.realsense import RealSenseCamera, RealSenseCameraConfig
        from dual_arm.cameras import ColorMode, Cv2Rotation
    ...
    def connect(self, warmup: bool = True) -> None:
        ...
        try:
            ...
            raise ConnectionError(
                f"Failed to open {self}.Run `dual_arm-find-cameras realsense` to find available cameras."
            ) from e
