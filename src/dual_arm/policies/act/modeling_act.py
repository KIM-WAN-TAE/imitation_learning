...
from dual_arm.utils.constants import ACTION, OBS_ENV_STATE, OBS_IMAGES, OBS_STATE
...
class ACTTemporalEnsembler:
    def __init__(self, temporal_ensemble_coeff: float, chunk_size: int) -> None:
        ...
        https://github.com/huggingface/dual_arm/pull/319 hint at why highly weighing new actions might be
