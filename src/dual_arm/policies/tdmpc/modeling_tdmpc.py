...
from dual_arm.policies.utils import get_device_from_parameters, get_output_shape, populate_queues
from dual_arm.utils.constants import ACTION, OBS_ENV_STATE, OBS_IMAGE, OBS_PREFIX, OBS_STATE, OBS_STR, REWARD
...
class TDMPCPolicy(PreTrainedPolicy):
    ...
    Please note several warnings for this policy.
        - Evaluation of pretrained weights created with the original FOWM code
            ...
            https://github.com/huggingface/dual_arm/pull/103 for implementation details.
        ...
        - Nevertheless, we have verified that we can train TD-MPC for PushT. See
          `dual_arm/configs/policy/tdmpc_pusht_keypoints.yaml`.
