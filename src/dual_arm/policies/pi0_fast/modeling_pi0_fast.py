...
from dual_arm.utils.import_utils import _scipy_available, _transformers_available
...
from dual_arm.policies.pi0_fast.configuration_pi0_fast import PI0FastConfig
from dual_arm.policies.pretrained import PreTrainedPolicy, T
...
class PI0FastPytorch(nn.Module):  # see openpi `PI0Pytorch`
    ...
    def __init__(
        ...
        msg = """An incorrect transformer version is used, please create an issue on https://github.com/huggingface/dual_arm/issues"""
