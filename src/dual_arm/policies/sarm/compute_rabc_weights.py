...
Usage:
    ...
    python src/dual_arm/policies/sarm/compute_rabc_weights.py \\
        --dataset-repo-id dual_arm/aloha_sim_insertion_human \\
...
from dual_arm.policies.sarm.sarm_utils import normalize_stage_tau
