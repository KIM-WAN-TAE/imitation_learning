...
from dual_arm.envs.factory import make_env
from dual_arm.processor import RobotAction, RobotObservation
from dual_arm.robots.unitree_g1.g1_utils import G1_29_JointArmIndex, G1_29_JointIndex
from dual_arm.robots.unitree_g1.robot_kinematic_processor import G1_29_ArmIK
...
class UnitreeG1(Robot):
    ...
    def __init__(self, config: UnitreeG1Config):
        ...
        if config.is_simulation:
            ...
            from dual_arm.robots.unitree_g1.unitree_sdk2_socket import (
                ChannelFactoryInitialize,
                ChannelPublisher,
                ChannelSubscriber,
            )
    ...
    def connect(self, calibrate: bool = True) -> None:  # connect to DDS
        ...
        if self.config.is_simulation:
            ...
            self._env_wrapper = make_env("dual_arm/unitree-g1-mujoco", trust_remote_code=True)
