...
# AX-12A baud rate table (Baud_Rate register value)
# https://emanual.robotis.com/docs/en/dxl/ax/ax-12a/#baud-rate-4
AX_12A_BAUDRATE_TABLE = {
    9_600: 207,
    19_200: 103,
    57_600: 34,
    115_200: 16,
...
# AX-12A does not use two's-complement encoding for the registers we read/write here.
AX_12A_ENCODINGS_TABLE: dict[str, int] = {}
...
MODEL_ENCODING_TABLE = {
    ...
    "xh430-v210": X_SERIES_ENCODINGS_TABLE,
    "xh430-v350": X_SERIES_ENCODINGS_TABLE,
...
MODEL_OPERATING_MODES = {
    ...
    "xl430-w250": [1, 3, 4, 16],
    "xh430-v210": [0, 1, 3, 4, 5, 16],
    "xh430-v350": [0, 1, 3, 4, 5, 16],
...
MODEL_CONTROL_TABLE = {
    ...
    "xh430-v210": X_SERIES_CONTROL_TABLE,
    "xh430-v350": X_SERIES_CONTROL_TABLE,
...
MODEL_BAUDRATE_TABLE = {
    ...
    "xh430-v210": X_SERIES_BAUDRATE_TABLE,
    "xh430-v350": X_SERIES_BAUDRATE_TABLE,
    "xm430-w350": X_SERIES_BAUDRATE_TABLE,
    "xm540-w270": X_SERIES_BAUDRATE_TABLE,
    "xc430-w150": X_SERIES_BAUDRATE_TABLE,
    "ax-12a": AX_12A_BAUDRATE_TABLE,
}
# Model -> protocol version (for bus auto-selection / mixed-protocol dispatch)
...
# ----------------- AX-12A (TEMP / likely Protocol 1.0) -----------------
# NOTE: This project currently uses Protocol 2.0 bus. AX-12A typically uses Protocol 1.0,
# so adding these tables will NOT make it work unless you also implement a Protocol 1.0 bus.
AX12A_CONTROL_TABLE = {
    # Minimal keys referenced by LeRobot code paths
    # Addresses below are Protocol 1.0 style for AX series (for reference)
    "Model_Number": (0, 2),
    "Firmware_Version": (2, 1),
    "ID": (3, 1),
    "Baud_Rate": (4, 1),
...
AX12A_BAUDRATE_TABLE = {
    # AX-12A Protocol 1.0 baud mapping is different from X-series
...
AX12A_ENCODINGS_TABLE = {
    # signed/2's complement handling not defined here; keep empty for now
}

# Add model keys (string must match Motor(..., model=...))
MODEL_CONTROL_TABLE["ax-12a"] = AX12A_CONTROL_TABLE
MODEL_BAUDRATE_TABLE["ax-12a"] = AX12A_BAUDRATE_TABLE
MODEL_ENCODING_TABLE["ax-12a"] = AX12A_ENCODINGS_TABLE
MODEL_RESOLUTION["ax-12a"] = 1024  # AX-12A is 0~1023
MODEL_NUMBER_TABLE["ax-12a"] = 12  # AX-12A model number (reference)

from typing import Literal
DynamixelModel = Literal[
    "x_series",
    "xl330-m077",
    "xl330-m288",
    "xl430-w250",
