...
from dual_arm.processor.pipeline import (
    ObservationProcessorStep,
    ProcessorStepRegistry,
)
from dual_arm.robots import Robot
from dual_arm.utils.constants import OBS_STATE
...
class MotorCurrentProcessorStep(ObservationProcessorStep):
    ...
    Attributes:
        robot: An instance of a `dual_arm` Robot class that provides access to
               the hardware bus.
    """
