...
import cv2
import torch
from torchvision.transforms.functional as F  # type: ignore  # noqa: N812
from tqdm import tqdm  # type: ignore

from dual_arm.datasets.lerobot_dataset import LeRobotDataset
from dual_arm.utils.constants import DONE, REWARD
...
def get_image_from_dual_arm_dataset(dataset: LeRobotDataset):
    """
...
def convert_dual_arm_dataset_to_cropped_dual_arm_dataset(
...
if __name__ == "__main__":
    ...
    images = get_image_from_dual_arm_dataset(dataset)
    ...
    cropped_resized_dataset = convert_dual_arm_dataset_to_cropped_dual_arm_dataset(
