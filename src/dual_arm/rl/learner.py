...
```bash
python -m dual_arm.rl.learner --config_path src/dual_arm/configs/train_config_hilserl_so100.json
```
...
https://github.com/michel-aractingi/dual_arm-hilserl-guide
"""
...
from dual_arm.cameras import opencv  # noqa: F401
from dual_arm.configs import parser
from dual_arm.configs.train import TrainRLServerPipelineConfig
from dual_arm.datasets.factory import make_dataset
...
from dual_arm.rl.buffer import ReplayBuffer, concatenate_batch_transitions
from dual_arm.rl.process import ProcessSignalHandler
from dual_arm.rl.wandb_utils import WandBLogger
from dual_arm.robots import so_follower  # noqa: F401
from dual_arm.teleoperators import gamepad, so_leader  # noqa: F401
from dual_arm.teleoperators.utils import TeleopEvents
from dual_arm.transport import services_pb2_grpc
from dual_arm.transport.utils import (
    MAX_MESSAGE_SIZE,
...
from dual_arm.utils.random_utils import set_seed
from dual_arm.utils.train_utils import (
    get_step_checkpoint_dir,
    load_training_state as utils_load_training_state,
    save_checkpoint,
    update_last_checkpoint,
)
from dual_arm.utils.transition import move_state_dict_to_device, move_transition_to_device
...
def save_training_checkpoint(
    ...
    replay_buffer.to_dual_arm_dataset(repo_id=repo_id_buffer_save, fps=fps, root=dataset_dir)
    ...
    if offline_replay_buffer is not None:
        ...
        offline_replay_buffer.to_dual_arm_dataset(
            cfg.dataset.repo_id,
            fps=fps,
...
def initialize_replay_buffer(
    ...
    return ReplayBuffer.from_dual_arm_dataset(
        dual_arm_dataset=dataset,
        capacity=cfg.policy.online_buffer_capacity,
        device=device,
        state_keys=cfg.policy.input_features.keys(),
        optimize_memory=True,
...
def initialize_offline_replay_buffer(
    ...
    offline_replay_buffer = ReplayBuffer.from_dual_arm_dataset(
        offline_dataset,
        device=device,
        state_keys=cfg.policy.input_features.keys(),
        storage_device=storage_device,
