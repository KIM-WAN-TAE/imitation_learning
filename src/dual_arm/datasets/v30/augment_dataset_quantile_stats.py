...
```bash
python src/dual_arm/datasets/v30/augment_dataset_quantile_stats.py \
...
from dual_arm.datasets.compute_stats import DEFAULT_QUANTILES, aggregate_stats, get_feature_stats
from dual_arm.datasets.lerobot_dataset import CODEBASE_VERSION, LeRobotDataset
from dual_arm.datasets.utils import write_stats
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Repository ID of the dataset (e.g., 'dual_arm/pusht')",
    )
