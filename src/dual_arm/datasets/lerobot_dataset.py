...
from dual_arm.datasets.compute_stats import aggregate_stats, compute_episode_stats
from dual_arm.datasets.image_writer import AsyncImageWriter, write_image
from dual_arm.datasets.utils import (
...
from dual_arm.datasets.video_utils import (
    VideoFrame,
...
from dual_arm.utils.constants import HF_LEROBOT_HOME
...
class LeRobotDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        1. Your dataset already exists:
            ...
            - On the Hugging Face Hub at the address https://huggingface.co/datasets/{repo_id} and not on
              ...
              dual_arm/datasets/v30/convert_dataset_v21_to_v30.py.
    ...
    def add_frame(self, frame: dict) -> None:
        ...
        safe_fps = self.fps if self.fps > 0 else 1
        timestamp = frame.pop("timestamp") if "timestamp" in frame else frame_index / safe_fps
...
class MultiLeRobotDataset(torch.utils.data.Dataset):
    ...
    @property
    def meta(self):
        """Returns a metadata object compatible with LeRobotDataset.meta."""
        return self
    ...
    def features(self) -> dict[str, dict]:
        ...
        for dataset in self._datasets:
            features.update({k: v for k, v in dataset.meta.features.items() if k not in self.disabled_features})
        return features
