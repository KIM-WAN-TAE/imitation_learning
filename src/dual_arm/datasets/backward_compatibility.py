...
```
python -m dual_arm.datasets.v30.convert_dataset_v21_to_v30 --repo-id={repo_id}
```
...
or open an [issue on GitHub](https://github.com/huggingface/dual_arm/issues/new/choose).
"""

FUTURE_MESSAGE = """
The dataset you requested ({repo_id}) is only available in {version} format.
As we cannot ensure forward compatibility with it, please update your current version of dual_arm.
"""
