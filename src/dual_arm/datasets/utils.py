...
from dual_arm.datasets.backward_compatibility import (
    FUTURE_MESSAGE,
    BackwardCompatibilityError,
    ForwardCompatibilityError,
)
from dual_arm.utils.constants import ACTION, OBS_ENV_STATE, OBS_STR
from dual_arm.utils.utils import SuppressProgressBars, is_valid_numpy_dtype_string
...
def create_dual_arm_dataset_card(
    tags: list | None = None,
    ...
    **kwargs,
    ...
    card_template = (importlib.resources.files("dual_arm.datasets") / "card_template.md").read_text()
