...
You want to evaluate a model from the hub (eg: https://huggingface.co/dual_arm/diffusion_pusht)
for 10 episodes.

```
dual_arm-eval \
    --policy.path=dual_arm/diffusion_pusht \
    --env.type=pusht \
    --eval.batch_size=10 \
    --eval.n_episodes=10 \
...
You can learn about the CLI options for this script in the `EvalPipelineConfig` in dual_arm/configs/eval.py
"""
...
from dual_arm.configs.eval import EvalPipelineConfig
from dual_arm.envs.factory import make_env, make_env_pre_post_processors
from dual_arm.envs.utils import (
    add_envs_task,
...
from dual_arm.utils.constants import ACTION, DONE, OBS_STR, REWARD
from dual_arm.utils.import_utils import register_third_party_plugins
from dual_arm.utils.io_utils import write_video
