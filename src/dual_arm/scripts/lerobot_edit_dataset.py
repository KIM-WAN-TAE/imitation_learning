...
Delete episodes 0, 2, and 5 from a dataset:
    python -m dual_arm.scripts.dual_arm_edit_dataset \
        --repo_id dual_arm/pusht \
...
Delete episodes and save to a new dataset:
    python -m dual_arm.scripts.dual_arm_edit_dataset \
        --repo_id dual_arm/pusht \
        --new_repo_id dual_arm/pusht_filtered \
        --operation.type delete_episodes \
        --operation.episode_indices "[0, 2, 5]"
...
Merge multiple datasets:
    python -m dual_arm.scripts.dual_arm_edit_dataset \
        --repo_id dual_arm/pusht_merged \
        --operation.type merge \
        --operation.repo_ids "['dual_arm/pusht_train', 'dual_arm/pusht_val']"
...
Convert image dataset to video format and save with new repo_id:
    python -m dual_arm.scripts.dual_arm_edit_dataset \
        --repo_id dual_arm/pusht_image \
        --new_repo_id dual_arm/pusht_video \
        --operation.type convert_image_to_video
...
from dual_arm.datasets.dataset_tools import (
...
def handle_convert_image_to_video(cfg: EditDatasetConfig) -> None:
    ...
    if cfg.new_repo_id:
        ...
        # Get the parent of the actual dataset root (not cfg.root which might be the dual_arm cache dir)
