...
from dual_arm.configs.types import FeatureType, PolicyFeature
...
class HubEnvConfig(EnvConfig):
    ...
    hub_path: Optional[str] = None  # required: e.g., "username/repo" or "username/repo@branch:file.py"
...
class AlohaEnv(EnvConfig):
    task: Optional[str] = "AlohaInsertion-v0"
    fps: int = 50
...
class InverseKinematicsConfig:
    ...
    end_effector_bounds: Optional[dict[str, list[float]]] = None
    end_effector_step_sizes: Optional[dict[str, float]] = None
...
class HILSerlProcessorConfig:
    ...
    image_preprocessing: Optional[ImagePreprocessingConfig] = None
    gripper: Optional[GripperConfig] = None
    reset: Optional[ResetConfig] = None
    inverse_kinematics: Optional[InverseKinematicsConfig] = None
    reward_classifier: Optional[RewardClassifierConfig] = None
    max_gripper_pos: Optional[float] = 100.0
...
class IsaaclabArenaEnv(HubEnvConfig):
    ...
    episode_length: int = 300
    num_envs: int = 1
    embodiment: Optional[str] = "gr1_pink"
    object: Optional[str] = "power_drill"
    mimic: bool = False
    ...
    environment: Optional[str] = "gr1_microwave"
    task: Optional[str] = "Reach out to the microwave and open it."
    state_dim: int = 54
    action_dim: int = 36
