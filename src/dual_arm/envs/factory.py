...
from dual_arm.envs.configs import AlohaEnv, EnvConfig, HubEnvConfig, IsaaclabArenaEnv, LiberoEnv, PushtEnv
from dual_arm.envs.utils import _call_make_env, _download_hub_file, _import_hub_module, _normalize_hub_result
from dual_arm.policies.xvla.configuration_xvla import XVLAConfig
from dual_arm.processor import ProcessorStep
from dual_arm.processor.env_processor import IsaaclabArenaProcessorStep, LiberoProcessorStep
from dual_arm.processor.pipeline import PolicyProcessorPipeline
...
def make_env_pre_post_processors(
    ...
    if isinstance(policy_cfg, XVLAConfig):
        from dual_arm.policies.xvla.processor_xvla import make_xvla_libero_pre_post_processors
...
def make_env(
    ...
    if "libero" in cfg.type:
        from dual_arm.envs.libero import create_libero_envs
        ...
        from dual_arm.envs.metaworld import create_metaworld_envs
