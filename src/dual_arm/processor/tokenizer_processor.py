...
from dual_arm.configs.types import FeatureType, PipelineFeatureType, PolicyFeature
    ...
    def __post_init__(self):
        ...
        if not _transformers_available:
            raise ImportError(
                ...
                "Please install it with `pip install 'dual_arm[transformers-dep]'` to use TokenizerProcessorStep."
            )
...
class ActionTokenizerProcessorStep(ActionProcessorStep):
    ...
    def __post_init__(self):
        ...
        if not _transformers_available:
            raise ImportError(
                "The 'transformers' library is not installed. "
                "Please install it with `pip install 'dual_arm[transformers-dep]'` to use ActionTokenizerProcessorStep."
            )
