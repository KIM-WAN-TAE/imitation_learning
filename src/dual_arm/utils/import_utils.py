...
def make_device_from_device_class(config: ChoiceRegistry) -> Any:
    ...
    module_path = config_cls.__module__  # typical: dual_arm_teleop_mydevice.config_mydevice
    ...
    candidates = [
        parent_module,  # typical: dual_arm_teleop_mydevice
        parent_module + "." + device_class_name.lower(),  # typical: dual_arm_teleop_mydevice.mydevice
    ]
...
def register_third_party_plugins() -> None:
    ...
    (including editable installs) starting with 'dual_arm_robot_', 'dual_arm_camera_',
    'dual_arm_teleoperator_', or 'dual_arm_policy_' and imports them.
    """
    prefixes = ("dual_arm_robot_", "dual_arm_camera_", "dual_arm_teleoperator_", "dual_arm_policy_")
    imported: list[str] = []
    failed: list[str] = []
