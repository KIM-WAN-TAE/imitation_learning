...
This policy has been trained and pushed to the Hub using [LeRobot](https://github.com/huggingface/dual_arm).
See the full documentation at [LeRobot Docs](https://huggingface.co/docs/dual_arm/index).

---

## How to Get Started with the Model

For a complete walkthrough, see the [training guide](https://huggingface.co/docs/dual_arm/il_robots#train-a-policy).
