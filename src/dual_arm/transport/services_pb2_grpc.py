...
from dual_arm.transport import services_pb2 as dual_arm_dot_transport_dot_services__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in dual_arm/transport/services_pb2_grpc.py depends on'
...
class LearnerServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.StreamParameters = channel.unary_stream(
                ...
                request_serializer=dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
                response_deserializer=dual_arm_dot_transport_dot_services__pb2.Parameters.FromString,
                _registered_method=True)
        self.SendTransitions = channel.stream_unary(
                '/transport.LearnerService/SendTransitions',
                request_serializer=dual_arm_dot_transport_dot_services__pb2.Transition.SerializeToString,
                response_deserializer=dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
                _registered_method=True)
        self.SendInteractions = channel.stream_unary(
                '/transport.LearnerService/SendInteractions',
                request_serializer=dual_arm_dot_transport_dot_services__pb2.InteractionMessage.SerializeToString,
                response_deserializer=dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
                _registered_method=True)
...
def add_LearnerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamParameters': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
                    response_serializer=dual_arm_dot_transport_dot_services__pb2.Parameters.SerializeToString,
            ),
            'SendTransitions': grpc.stream_unary_rpc_method_handler(
                    servicer.SendTransitions,
                    request_deserializer=dual_arm_dot_transport_dot_services__pb2.Transition.FromString,
                    response_serializer=dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
            ),
            'SendInteractions': grpc.stream_unary_rpc_method_handler(
                    servicer.SendInteractions,
                    request_deserializer=dual_arm_dot_transport_dot_services__pb2.InteractionMessage.FromString,
                    response_serializer=dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
            ),
...
class LearnerService:
    ...
    def StreamParameters(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/transport.LearnerService/StreamParameters',
            dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
            dual_arm_dot_transport_dot_services__pb2.Parameters.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SendTransitions(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/transport.LearnerService/SendTransitions',
            dual_arm_dot_transport_dot_services__pb2.Transition.SerializeToString,
            dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SendInteractions(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/transport.LearnerService/SendInteractions',
            dual_arm_dot_transport_dot_services__pb2.InteractionMessage.SerializeToString,
            dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
...
class AsyncInferenceStub:
    ...
    def __init__(self, channel):
        ...
        self.SendObservations = channel.stream_unary(
                ...
                request_serializer=dual_arm_dot_transport_dot_services__pb2.Observation.SerializeToString,
                response_deserializer=dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
                _registered_method=True)
        self.GetActions = channel.unary_unary(
                '/transport.AsyncInference/GetActions',
                request_serializer=dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
                response_deserializer=dual_arm_dot_transport_dot_services__pb2.Actions.FromString,
                _registered_method=True)
        self.SendPolicyInstructions = channel.unary_unary(
                '/transport.AsyncInference/SendPolicyInstructions',
                request_serializer=dual_arm_dot_transport_dot_services__pb2.PolicySetup.SerializeToString,
                response_deserializer=dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
                _registered_method=True)
        self.Ready = channel.unary_unary(
...
def add_AsyncInferenceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendObservations': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=dual_arm_dot_transport_dot_services__pb2.Observation.FromString,
                    response_serializer=dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
            ),
            'GetActions': grpc.unary_unary_rpc_method_handler(
                    servicer.GetActions,
                    request_deserializer=dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
                    response_serializer=dual_arm_dot_transport_dot_services__pb2.Actions.SerializeToString,
            ),
            'SendPolicyInstructions': grpc.unary_unary_rpc_method_handler(
                    servicer.SendPolicyInstructions,
                    request_deserializer=dual_arm_dot_transport_dot_services__pb2.PolicySetup.FromString,
                    response_serializer=dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
            ),
            'Ready': grpc.unary_unary_rpc_method_handler(
                    servicer.Ready,
...
class AsyncInference:
    ...
    def SendObservations(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/transport.AsyncInference/SendObservations',
            dual_arm_dot_transport_dot_services__pb2.Observation.SerializeToString,
            dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetActions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/transport.AsyncInference/GetActions',
            dual_arm_dot_transport_dot_services__pb2.Empty.SerializeToString,
            dual_arm_dot_transport_dot_services__pb2.Actions.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SendPolicyInstructions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/transport.AsyncInference/SendPolicyInstructions',
            dual_arm_dot_transport_dot_services__pb2.PolicySetup.SerializeToString,
            dual_arm_dot_transport_dot_services__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
